...
df2.to_excel(caminho, index=False) #salvando o df filtrado de valores de nulos
...
print(df_pontuado.sort_values("Pontuação Final", ascending=False).head())
